                                                ...
                                                <div class="col-sm-6 border-sm-left ">
                                                    <table class="w-100 ml-sm-4">
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <th class="py-1 fw-600" style="width:55%">{{ translate('Jamath') }}</th>
                                                                <td class="py-1">
                                                        ...
                                                        <table class="w-100">
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    <td class="py-1 fw-600">
                                                                        <i class="las text-primary mr-2 la-building"></i>
                                                                        <span>{{ translate('District (Level)') }}</span>
                                                                    </td>
                                                                    <td class="py-1">
                                                                        {{ $present_address->sub_city_id  ?? '' }}
                                            ...
                                            <table class="table table-borderless border table-responsive">
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <th>{{ translate('Education Details') }}</th>
                                                ...
                                                <div class="row no-gutters">
                                                    <div class="col-md-6">
                                                        <table class="w-100">
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    <th class="py-1">{{ translate('Gharana') }}
                                                                    </th>
                                                                    <td class="py-1">
                                                                ...
                                                                <tr>
                                                                 ...
                                                                 <tr>
                                                                    <th class="py-1">
                                                                        {{ translate('Property Type') }}</th>
                                                                    <td class="py-1">
                                                                        {{ $user->spiritual_backgrounds->property ?? '' }}
                                                                    </td>
                                                                </tr>
                                                            </tbody>
                                                        </table>
                                                    ...
                                                    <div class="col-sm-6 border-sm-left ">
                                                        <table class="w-100 ml-sm-4">
                                                            <tbody>
                                                                <tr>
                                                                    <th class="py-1">{{ translate('Jamath') }}</th>
                                                                    <td class="py-1">
                                                                        {{ $user->spiritual_backgrounds->caste->name ?? '' }}
                                                                    </td>
                                                                </tr>
                                                        ...
                                                        <table class="w-100">
                                                            <tbody>
                                                                <tr>
                                                                 ...
                                                                 <tr>
                                                                    <th class="py-1">{{ translate('District (Level)') }}</th>
                                                                    <td class="py-1">
                                                                      {{ $permanent_address->sub_city_id ?? '' }}
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                        ...
                                        <div id="family-info" class="collapse accordion-body ml-3 ml-md-5 pl-25px"
                                            ...
                                            <div class="border p-3">
                                                <div class="row no-gutters">
                                                    <div class="col-md-12">
                                                        <table class="w-100">
                                                             <tr>
                                                                    ...
                                                                    <th>{{translate('Job')}}</th>
                                                                    <th>{{translate('Education')}}</th>
                                                                    <th>{{translate('Marriage Status')}}</th>
                                                            ...
                                                            <!--<tbody>-->
                                                            <!--    <tr>-->
                                                            <!--        <th class="py-1">{{ translate('Name') }}</th>-->
                                                            <!--        <td class="py-1">-->
                                                            <!--            {{ $user->families->name ?? '' }}-->
                                                            <!--        </td>-->
                                                            <!--    </tr>-->
                                                            <!--    <tr>-->
                                                            <!--        <th class="py-1">{{ translate('Relationship') }}-->
                                                            <!--        </th>-->
                                                            <!--        <td class="py-1">-->
                                                            <!--            {{ $user->families->relationship ?? '' }}-->
                                                            <!--        </td>-->
                                                            <!--    </tr>-->
                                                            <!--</tbody>-->
                                                        </table>
                                                    ...
                                                    <!--        <tbody>-->
                                                    <!--            <tr>-->
                                                    <!--                <th class="py-1">{{ translate('Education') }}</th>-->
                                                    <!--                <td class="py-1">-->
                                                    <!--                    {{ $user->families->feducation ?? '' }}-->
                                                    <!--                </td>-->
                                                    <!--            </tr>-->
                                                    <!--            <tr>-->
                                                    <!--                <th class="py-1">{{ translate('Married Status') }}-->
                                                    <!--                </th>-->
                                                    <!--                <td class="py-1">-->
                                                    <!--                    {{ $user->families->married_status ?? '' }}-->
                                                    <!--                </td>-->
                                                    <!--            </tr>-->
                                                    <!--        </tbody>-->
                                                    <!--    </table>-->
                                ...
                                <div class="">
                                    <table class="table table-responsive">
                                        ...
                                        <tr>
                                            ...
                                            <th>{{ translate('Jamath') }}</th>
                                            <td>{{ $user->partner_expectations->caste->name ?? '' }}
                                            </td>
                                        </tr>

                                        <tr>
                                            <th>{{ translate('Gharana') }}</th>
