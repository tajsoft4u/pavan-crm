                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col">
                                            ...
                                            <div class="h4 mt-2 mb-2"><b> <?php $pending = $this->db->get('orders');
                                                                            echo $pending->num_rows() ?></b></div>
                                        </div>
                                        <div class="col-auto align-self-center ">
                                            <div class="feature-1 mt-0 mb-0"> <i class="fe fe-box   project bg-primary text-white"></i>
                                            </div>
                                        </div>
                                    </div>
                                </div>
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.status == 1) {
                        ...
                        trObj.find(".editSpan.address2").text(response.data.address2);
                        ...
                        trObj.find(".editSpan.scity").text(response.data.scity);
                        trObj.find(".editSpan.sstate").text(response.data.sstate);
                        trObj.find(".editSpan.spincode").text(response.data.spincode);
                        trObj.find(".editSpan.saddress").text(response.data.saddress);
                        trObj.find(".editSpan.ordersource").text(response.data.ordersource);
